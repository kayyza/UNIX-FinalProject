...
In this document, we'll be discussing the various parts that our technology stack is composed of. This includes a description of the technology itself, it's purpose, and why we chose this solution another one.

## Infrastructure:

### Containerization:

To handle the containerization for our project, we have decided to use Docker. 
     
Why use Docker?

- Docker simplifies deployment and testing.
- Docker ensures that there is consistency between the local environment and the server's environment.
